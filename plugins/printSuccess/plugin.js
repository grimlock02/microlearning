...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native mobileApp initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this mobileapp : https://thecodingmachine.github.io/react-native-mobileapp/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-mobileapp/issues'
			);
			console.log(
				'- ⭐ If you love this mobileapp, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-mobileapp'
			);
